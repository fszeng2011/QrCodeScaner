...
/**
 * Manages beeps and vibrations for {@link QrCapture}. 管理声音和震动
 */
public final class BeepManager implements MediaPlayer.OnCompletionListener,
	...
	private boolean shouldBeep() {
		boolean shouldPlayBeep = Config.playBeep;
		if (shouldPlayBeep) {
	...
	private MediaPlayer buildMediaPlayer(Context activity) {
		MediaPlayer mediaPlayer = MediaPlayer.create(activity, R.raw.beep);
