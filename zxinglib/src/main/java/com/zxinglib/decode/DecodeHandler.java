...
public final class DecodeHandler extends Handler {
	...
	DecodeHandler(QrCapture qrCapture, Map<DecodeHintType, Object> hints) {
	...
	private void decode(byte[] data, int width, int height) {
		...
		PlanarYUVLuminanceSource source = qrCapture.getCameraManager().buildLuminanceSource(data, width, height);
		if (source != null) {
		...
		Handler handler = qrCapture.getHandler();
		if (rawResult != null) {
